...
public class profile_methods {
    ...
    public static void main(String[] args) {
        try {
            ...
            changeState("ash", "sssssss", "qqqqqq");
...
//    public static void main(String[] args) {
//        try {
//            new model.database().conn("root", "", "127.0.0.1");
//
//            List <List> l= get_masters("ash");
//           for (int h=0 ; h<l.get(0).size() ; h++)
//           {
//              model.student d= (model.student)l.get(0).get(h);
//               System.out.println(d.getFull_name());
//
//
//                model.master v= (model.master)l.get(1).get(h);
//               System.out.println(v.getEnglish_name());
//
//
//               model.doctor g= (model.doctor) l.get(2).get(h);
//               System.out.println(g.getFull_name());
//
//           }
//           model.master mas=new model.master();
//           mas.setArabic_name("رساله");
//           mas.setDate_Regist("2015-01-01");
//           mas.setDate_remake_status("2015-09-01");
//           mas.setEnglish_name("master");
//           mas.setResion("resion");
//           mas.setStatus("acept");
//           mas.setSubject("subject");
//           System.out.println(add_master(mas,"ash"));
