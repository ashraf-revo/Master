...
<form method="post" action="login">
    ...
    <div class="mainform">
        <div class="secform">
            ...
            <input type="password" name="password" value="">&nbsp&nbsp<input type="submit" value="forget" name="forget"/>
            <br><br><br>
            <label>doc</label>
            ...
            <div class="button">
                ...
                &nbsp&nbsp
                <button><a href="file:///D:/adel/study/html/software%20project/account.html">Register</a></button>
            </div>
        </div>
    </div>
