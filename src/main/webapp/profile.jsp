...
<div class="header">
  ...
  box-shadow: 0 3px 2px rgba(0, 0, 0, 0.3); "/>
            <ul>
                <li><a href="#">Abo<span style="color:#ffffff">Ut</span></a></li>
                <li><a href="#">View <span style="color:#ffffff">Master's</span></a></li>
                <li><a href="#">Upload <span style="color:#ffffff">Master's</span></a></li>
                <li><a href="#contact">Contact<span style="color:#ffffff">Us</span></a></li>
            </ul>
        </div>
  ...
  if (master.getId_master()!=null)     {%>
    <div class="panel panel-danger" data-collapsed="0">
        ...
        <div class="panel-title" style="float: left;margin-left: 0px">
            <p style="color: #03cc85;margin-left: 100px"> ststus : <%=master.getStatus()%></p>
